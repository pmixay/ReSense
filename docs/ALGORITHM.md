...
rails. Measured in EXPERIMENTS §1k (set O #6: 1 STOP frame; nothing else changed).
...
* **The edge tests are ambiguous.** The organizers placed the objects from the sensor's axis,
  ...
  ([`QUESTIONS.md`](QUESTIONS.md) Q1). Since 26.09 (EXPERIMENTS §1k): measured from the sensor
