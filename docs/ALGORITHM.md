...
item 8), 8 of 8 since the near escalation of 26.09 (below; EXPERIMENTS §1k). Per-object grade and the config sweeps:
...
* **Near-field escalation (26.09, EXPERIMENTS §1k).** Within 35 m, a track whose last 5 hits each
