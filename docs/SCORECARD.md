...
| 4 | Finish the DDS start-up fix (in progress), then state the measured loss in README.md and SUBMISSION.md. The stored logs show 4.5–4.9 s, not 2–4 s. | 8.3, 8.6, 8.1 | P1 | in progress |
