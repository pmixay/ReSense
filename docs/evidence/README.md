...
|---|---|---|---|---|
| [`regression_baseline_2026-09-25_ride_p3b.json`](results/regression_baseline_2026-09-25_ride_p3b.json) | 25.09 | `30d0cac` (wf10/p3-round2: the four P3 items of round 2 merged on `f46a669`, `health.clear_cap` and `cluster.hanging_needs_rails` on), native path, config sha256 `591a26e1…` | `scripts/regression_gate.py --cache /data/cache --jobs 3 --baseline results/regression_baseline_2026-09-25_ride_p3.json` (six recordings, `cloud_with_fake_obj`, the ride in 8 pieces, set F straight; 333 s, dev VM alone); the comparison block is in `p3_round2_combined` | the current gate baseline: five bags 58 / 13 / 16, ride 187 / 46 / 39, `doubleT_obstacle` 186 of 246 from frame 11, set O 337 of 801 inside STOP frames, 6 of 8 objects with a STOP (hanging cube 30 from 52.5 m, 5 cm hanging object 15 from 30.1 m), set F straight person 151.0 m, false detections 26; PASS against the `_ride_p3` one, 6 gated rows better; EXPERIMENTS "Current results", §1i; EVALUATION §3 step 6; CAPTAIN §6 |
