...
class ClusterConfig:
    ...
    floating_free_max_size: float = 0.0   # m, 25.09 round 2 (organizers' set O cube #2; 0 = off): > 0 = the floating signature does not demote a compact cluster hanging free inside the envelope: every extent at most this,
