...
class TrackingConfig:
    ...
    stop_keep_min_voxels: int = 0  # 26.09 (P3 range round 2, EXPERIMENTS.md 1o; 0 = no bar): a cluster counts for a STOP track through stop_keep_signature or stop_keep_thin only with at least this many voxels inside the strict envelope (Cluster.n_gauge); 10 = the near escalation's bar (near_escalate_voxels)
