...
class TrackingConfig:
    ...
    low_min_seen_distance: float = 0.0  # 26.09 (P3 start-up, candidate c): m; a low (bed-level) track is reported only once it has been matched at or beyond this distance (lowobj.template_range[0] = 4 m: nearer, the rail-head plane is extrapolated); 0 = off
