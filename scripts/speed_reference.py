...
Measured on 24.09 (docs/EXPERIMENTS.md "Train speed"): the reference is valid on 94-100 % of
the frames of every recording, its frame-to-frame noise is 0.01-0.03 m/s and the scan and the
