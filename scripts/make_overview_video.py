...
BLOCKS = [
    ...
    {"name": "Алгоритм", "t0": 38.0, "t1": 56.0,
     ...
     "cards": [
         ...
         num(50.4, "23–31 мс", "на кадр · одно ядро CPU с ядрами на C++ · без GPU", REAL),
     ],
     "subs": [
         ...
         (44.6, 50.2, "На выходе — GO, CAUTION, STOP или FAULT и расстояние, до которого путь "
                      "проверенно свободен."),
         (50.4, 55.6, "23–31 миллисекунда на кадр на одном ядре, без видеокарты."),
     ]},
    {"name": "Демонстрация", "t0": 56.0, "t1": 93.0,
     ...
     "cards": [
         ...
         num(81.2, "125 из 126", "кадров с предметом на рельсе", REAL),
     ],
     "subs": [
    ...
    {"name": "Объекты организаторов", "t0": 93.0, "t1": 123.0,
     ...
     "cards": [
         ...
         num(111.0, "8 из 8", "объектов в габарите — STOP; у края лишь 2 и 6 кадров", ORG),
     ],
     "subs": [
         ...
         (109.8, 115.6, "Кубы по 30 сантиметров — только с 43–53 метров: вдали от них 2–4 точки."),
         (115.8, 122.4, "Висящий предмет 5 см — STOP с 30 метров. На краю STOP лишь в 2 и 6 кадрах."),
     ]},
    {"name": "Цифры", "t0": 123.0, "t1": 145.0,
     ...
     "cards": [
         ...
         num(127.4, "3,5 на км", "ложного события на поездке, где решались правила (45 за 13 км)", REAL),
     ...
     "subs": [
         ...
         (127.4, 131.0, "3,5 ложного события на километр — на той же поездке, где решались правила."),
         (131.4, 136.0, "На нашей синтетике человек на подходе по прямой подтверждён на 148 метрах;"),
