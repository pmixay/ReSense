...
BLOCKS = [
    ...
    {"name": "Объекты организаторов", "t0": 93.0, "t1": 123.0,
     ...
     "cards": [
         ...
         num(111.0, "6 из 8", "объектов в габарите — STOP; устойчиво 5", ORG),
     ],
     "subs": [
         ...
         (115.8, 122.4, "Висящий предмет в 5 сантиметров найден с 30 метров. Ящик у края габарита "
                        "пропущен — и мы говорим об этом прямо."),
     ]},
