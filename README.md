...
| `health.clear_cap` | false | tried, not shipped (25.09): caps `clear_distance` at the nearest unconfirmed or advisory cluster in the envelope, columns excluded; no decision changes. Set O overclaim 172 → 82 object-frames, but the five obstacle-free recordings' median clear distance −5.5 % (limit 5 %; EXPERIMENTS §1i) |
